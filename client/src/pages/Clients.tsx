...
export const serviceTypes: Record<string, string[]> = {
  "سكن خاص": ["بناء جديد", "تعديل", "إضافة", "تعديل وإضافة", "إضافة مبنى قائم", "إضافة مبنى قائم بدون ترخيص", "هدم", "إشراف"],
  "صناعي": ["بناء جديد", "تعديل", "إضافة", "تعديل وإضافة", "إضافة مبنى قائم", "إضافة مبنى قائم بدون ترخيص", "هدم"],
  "استثماري": ["بناء جديد", "تعديل", "إضافة", "تعديل وإضافة", "إضافة مبنى قائم", "إضافة مبنى قائم بدون ترخيص", "هدم"],
  "تجاري": ["بناء جديد", "تعديل", "إضافة", "تعديل وإضافة", "إضافة مبنى قائم", "إضافة مبنى قائم بدون ترخيص", "هدم"],
};
    ...
    <div className="min-h-screen bg-gray-50" dir="rtl">
      ...
      <div className="px-6 py-3 bg-white border-b flex items-center gap-2 flex-wrap">
        ...
        <select value={filterServiceType} onChange={(e) => setFilterServiceType(e.target.value)}
          ...
          <option value="إضافة مبنى قائم بدون ترخيص">إضافة مبنى قائم بدون ترخيص</option>
