...
- [ ] إنشاء نموذج طلبات المشروع الرقمي مع Canvas للرسم بالقلم
- [ ] حقول النموذج: اسم المالك، رقم التلفون، بيانات القسيمة، مكونات كل دور، اتجاه الشمال، الطابع المعماري، مساحة الأرض
- [ ] مساحة Canvas للرسم الحر (سكتش الكروكي) بالقلم على الآيباد
- [ ] حفظ النموذج مرتبطاً بالمشروع في قاعدة البيانات
- [ ] تحديث خطة عمل السكن الخاص بالمراحل والمهام الجديدة (7 مراحل)
- [ ] بناء آلية الإطلاق التلقائي للمهام عند اكتمال مهمة trigger
- [ ] ربط النموذج بصفحة تفاصيل المشروع وخطة العمل
