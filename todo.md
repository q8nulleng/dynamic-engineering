...
## تحديثات الخصم والمسودة
- [x] تعديل نظام الخصم ليكون مباشراً بدون موافقة
- [x] إظهار السعر القديم مشطوباً مع "قبل الخصم" و"بعد الخصم" في عرض السعر
- [x] إضافة "تصميم واجهات" في قائمة نوع الخدمة
- [x] حفظ بيانات نموذج الفرصة الجديدة تلقائياً كمسودة عند الإغلاق بدون حفظ
- [x] مؤشر "مسودة محفوظة" في عنوان Dialog الفرصة الجديدة
- [x] زر "مسح المسودة" في عنوان Dialog
