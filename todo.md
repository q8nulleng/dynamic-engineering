...
- [ ] إصلاح آلية الرفع لحفظ MIME type وامتداد الملف بشكل صحيح
- [ ] إعادة تصميم صفحة المستندات الرئيسية بأقسام واضحة + فلاتر
- [ ] بناء صفحة مستندات العميل مع معاينة أونلاين (PDF/صور/أوتوكاد)
- [ ] إضافة زر تنزيل يعمل بشكل صحيح
- [ ] إضافة زر مشاركة واتساب
- [ ] دعم رفع جميع الصيغ (PDF, AutoCAD, صور, Word, Excel)
- [ ] إصلاح مشكلة عدم فتح الملفات
