...
- [ ] إضافة جدول employees في schema مع الأدوار والصلاحيات وكلمة المرور المشفرة
- [ ] إنشاء API endpoints: تسجيل دخول الموظفين، الجلسة، إدارة الحسابات
- [ ] صفحة تسجيل دخول الموظفين (بريد + كلمة مرور)
- [ ] صفحة إدارة الموظفين للمدير (إضافة/تعديل/حذف/إعادة تعيين كلمة المرور)
- [ ] تطبيق صلاحيات الرؤية في الشريط الجانبي حسب الدور
- [ ] إنشاء حسابات الموظفين الستة في قاعدة البيانات
